...
public class Listwy_Zasilajace extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.listwy_zasilajace);
        ...
        wylacz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (poloncz.polacz(id,"2").equals("true")) {
                    ...
                    Toast.makeText(Listwy_Zasilajace.this, error , Toast.LENGTH_LONG).show();
                }
            }
        });
